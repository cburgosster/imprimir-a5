        ...
        if ($this->logo) {
            if (function_exists('imagecreatefromstring')) {
                ...
                if (substr(strtolower($this->logo), -4) == '.png') {
                    $this->pdf->addPngFromFile($this->logo, 30, 500, $tamanyo[0], $tamanyo[1]);
                    ...
                    if (imagepng(imagecreatefromstring(file_get_contents($this->logo)), FS_MYDOCS . 'images/logo.png')) {
                        $this->pdf->addPngFromFile(FS_MYDOCS . 'images/logo.png', 35, 500, $tamanyo[0], $tamanyo[1]);
                    } else {
                        $this->pdf->addJpegFromFile($this->logo, 35, 500, $tamanyo[0], $tamanyo[1]);
                    }
                } else {
                    $this->pdf->addJpegFromFile($this->logo, 35, 500, $tamanyo[0], $tamanyo[1]);
                }
